...
public class WurstplusUser extends Pinnable {
	...
	public void render() {
		...
		mc.fontRenderer.drawStringWithShadow(line, scaled_width / 2f - mc.fontRenderer.getStringWidth(line) / 2f, 20f, new ClientDraw.TravisColor(nl_r,nl_g,nl_b,nl_a).hex());
