...
public class WurstplusCombobox extends AbstractWidget {
	...
	public WurstplusCombobox(Frame frame, ModuleButton master, String tag, int update_postion) {
	...
	public void render(int master_y, int separe, int absolute_x, int absolute_y) {
		...
		ClientDraw.draw_string(this.combobox_name + " " + this.setting.get_current_value(), this.x + 2, this.save_y, ns_r, ns_g, ns_b, ns_a);
