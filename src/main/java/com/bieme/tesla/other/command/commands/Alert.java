...
public class Alert extends Command {
	...
	public boolean get_message(String[] message) {
		...
		if (message.length > 3) {
			MessageUtil.send_client_error_message(current_prefix() + "alert <ModuleName> <True/On/False/Off>");
			return true;
		}
		...
		Module module_requested = Client.get_hack_manager().get_module_with_tag(module);
		...
		MessageUtil.send_client_message("The actual value of " + module_requested.get_name() + " is " + value + ".");
